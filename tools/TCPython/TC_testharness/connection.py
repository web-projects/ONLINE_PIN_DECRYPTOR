...
from TC_testharness.exceptions import timeoutException
import TC_testharness.utility as tutil
import select
import pyDes
...
class Connection(object):
        ...
        def __init__(self):
            ...
            ini_name = path.join(path.dirname(path.realpath(__file__)),'./config/TC_analyse.ini')
